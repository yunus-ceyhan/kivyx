...
<XCard>:
    canvas.before:
        ...
        RoundedRectangle:
            ...
            radius: [root.radius[0]+(root.percent(root.distance,1)/10),] if root.soft else root.radius
        ...
        RoundedRectangle:
            ...
            radius: [root.radius[0]+(root.percent(root.distance,1.5)/10),] if root.soft else root.radius
        ...
        RoundedRectangle:
            ...
            radius: [root.radius[0]+(root.percent(root.distance,2.5)/10),] if root.soft else root.radius
        ...
        RoundedRectangle:
            ...
            radius: [root.radius[0]+(root.percent(root.distance,4)/10),] if root.soft else root.radius
        ...
        RoundedRectangle:
            ...
            radius: [root.radius[0]+(root.percent(root.distance,8.5)/10),] if root.soft else root.radius
        ...
        RoundedRectangle:
            ...
            radius: [root.radius[0]+(root.percent(root.distance,11.5)/10),] if root.soft else root.radius
        ...
        RoundedRectangle:
            ...
            radius: [root.radius[0]+(root.percent(root.distance,15.5)/10),] if root.soft else root.radius
        Color:
        ...
        RoundedRectangle:
            ...
            radius: [root.radius[0]+(root.percent(root.distance,19)/10),] if root.soft else root.radius
        ...
        RoundedRectangle:
            ...
            radius: [root.radius[0]+(root.percent(root.distance,25)/10),] if root.soft else root.radius
