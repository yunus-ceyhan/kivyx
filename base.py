...
<CodeEditor>:
    ...
    XToolbar:
        ...
        TextInput:
            ...
            foreground_color: code.foreground_color
            padding_y: [self.height/5,]
            size_hint: None,None
            width: dp(150)
            height: dp(30)
            on_text: root.on_text_search(self.text)
            padding_x: [10,0]
    ...
    BoxLayout:
        ...
        XCard:
            ...
            ScrollView:
                ...
                do_scroll_x: False
                do_scroll_y: False
                scroll_y: root.ids.scroller.scroll_y
                GridLayout:
                    id: num                                                         
                    orientation: 'lr-tb'
                    cols:1
        ...
        ScrollView:
            ...
            FloatLayout:
                ...
                CodeInput:
                    ...
                    selection_color: root.line_color
                    hint_text_color: root.txt_light
                ...
                ScrollView:
                    id: autoscrl
                    size_hint: None,None
                    size: dp(130),min(sglist.height,dp(130))
                    pos: code.cursor_pos[0] if root.xcode== 0 else code.cursor_pos[0] - self.width, code.cursor_pos[1] - (autoscrl.height+dp(20)) if root.ycode == 1 else code.cursor_pos[1] + dp(2)
                    scroll_y: 0
                    bar_color: root.accent_color
                    bar_inactive_color: 0,0,0,0      
                    effect_cls: 'ScrollEffect'
                    ...
                    BoxLayout:
                        ...
                        canvas.before:
                            Color:
                                rgba: (1,1,1,1) if len(self.children) > 0 else (0,0,0,0) 
                            RoundedRectangle:
                                size: self.size
                                pos: self.pos
                                radius: [6,] 
    ...
    FloatLayout:
        ...
        BoxLayout:
            size_hint: None,None
            size: lc.width+lr.width+ply.width+dp(20),dp(40)
            pos_hint: {'x':1.0-(1.0/(Window.width)*self.width),'y':((1.0/tb_panel.height)*(tb_panel.height-dp(40)))}
            XLabel:
                id: lr
                text: f"Ln {code.cursor_row+1}"
                aligned: True
                shorten: False
                markup: True
                halign: "left"
        ...
        TabbedPanel:
            ...
            tab_height: dp(30)
            tab_width: dp(90)
            background_normal: "a.png"
            background_down: ""
            TabbedPanelItem:
                text: "OUTPUT"
                background_color: (.5,.5,.5,.1) if app.theme_style == "Light" else (.5,.5,.5,.5)
                ...
                ScrollView:
                    ...
                    bar_width: 5
                    bar_inactive_color: 0,0,0,0
                    bar_color: root.line_color
                    bar_margin: 10
                    on_scroll_start: root.scroll_start(self.scroll_y)
                    on_scroll_move: root.scroll_move(self.scroll_y)
                    on_scroll_move: root.scroll_move(self.scroll_y)
                    CodeInput:
                        id: output
                        ...
                        hint_text_color: root.txt_light
                        pos_hint: {'center_x':.5,'center_y':.5}
                        height: max(self.minimum_height, scrll1.height)
                        size_hint: 1,None
                        background_color: 0,0,0,0
                        padding: [dp(40),dp(20),dp(20),dp(10)]
                        use_bubble: False
                        use_handles: False
                        foreground_color: root.txt_medium
                        multiline: True
                        #font_name: 'code.ttf'     
                        font_size: root.font_size
            ...
            TabbedPanelItem:
                ...
                ScrollView:
                    ...
                    CodeInput:
                        ...
                        hint_text_color: root.txt_light
                        pos_hint: {'center_x':.5,'center_y':.5}
                        height: max(self.minimum_height, scrll2.height)
                        size_hint: 1,None
                        background_color: 0,0,0,0
                        #padding: [dp(40),dp(20),dp(20),dp(10)]
                        use_bubble: False
...
class Suggest(RectangularBehavior, BoxLayout):
    text = StringProperty()
...
class CodeEditor(Theming,BoxLayout):
